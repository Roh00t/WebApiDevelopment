...
router.post('/events', function (req, res) {
    var data = req.body;
var organizerId = res.locals.organizer._id;
db.addEvent(data.name, data.description, data.startDate, data.startTime, data.endDate, data.endTime, organizerId, function (err, event) {
            if (err) {
                console.log(event);
